 ...
 * @author yeojvaldez
 */
public class guestRoomUnavailableDate extends javax.swing.JFrame {

    /**
     * Creates new form roomAdd
     */
    public guestRoomUnavailableDate() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(guestRoomUnavailableDate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
