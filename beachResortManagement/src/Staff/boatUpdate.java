 ...
 * @author yeojvaldez
 */
public class boatUpdate extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(boatUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
