 ...
 * @author yeojvaldez
 */
public class adminReservationBoat extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminReservationBoat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
